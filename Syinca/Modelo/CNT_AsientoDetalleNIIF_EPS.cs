namespace Modelo
{
    ...
    public partial class CNT_AsientoDetalleNIIF_EPS
    {
        ...
        public virtual CNT_AsientoNIIF_EPS CNT_AsientoNIIF_EPS { get; set; }

        public virtual CNT_PUC_NIIF_EPS CNT_PUC_NIIF_EPS { get; set; }
